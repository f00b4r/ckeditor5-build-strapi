 ...
 * Strapi 3.x
 *
 * File: project/extensions/content-manager/admin/src/components/WysiwygWithErrors/index.js
 * NPM: npm install --save-dev @ckeditor/ckeditor5-react ckeditor5-build-strapi
 *
*/
  ...
  render() {
    ...
    return (
      <CKEditor
        ...
        config={{
          toolbar: ['heading', '|', 'bold', 'italic', 'link', 'bulletedList', 'numberedList', '|', 'fontColor', 'fontBackgroundColor', '|', 'indent', 'outdent', '|', 'blockQuote', 'insertTable'],
          fontColor: {
            colors: [
              {
                color: 'hsl(0, 76%, 57%)',
